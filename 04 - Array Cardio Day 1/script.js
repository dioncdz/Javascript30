...
const first = inventors.filter(inventor => (inventor.year >= 1500 && inventor.year < 1600));
console.table(first);
...
const bySurname = people.sort((lastOne, nextOne) => {
...
let countedNames = data.reduce ((obj, vehicle) => {
  // if (vehicle in obj) {
  //   obj[vehicle]++;
  // } else {
  //   obj[vehicle] = 1;
